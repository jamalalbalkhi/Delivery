...
class _categoriesScreenState extends State<categoriesScreen> {
  ...
  // ];
  bool loading=false;
  List<Category>categorie=<Category>[];
@override
  void initState() {
    super.initState();
    getCatgories();
  ...
  var data=await categoryes_endpoint();
  setState(() {
    categorie=data;
    loading=false;
  });
        ...
        itemBuilder: (context,index){
          return Padding(
            ...
            child: ListTile(
              ...
              CircleAvatar(
                radius: 40,
                backgroundImage: AssetImage('assets/images/fastfood.jpg'),
              ),
              onTap: (){
                Navigator.push(
                  context,
